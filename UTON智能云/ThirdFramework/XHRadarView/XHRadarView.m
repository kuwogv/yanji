...
#define INDICATOR_START_COLOR [UIColor colorWithRed:86.0/255.0 green:127.0/255.0 blue:247.0/255.0 alpha:1]
...
- (void)drawRect:(CGRect)rect {
    ...
    for (int i=0; i<sectionsNum ; i++) {
        /*画圆*/
        //边框圆
        CGContextSetRGBStrokeColor(context, 135/255, 164/255, 248/255, (1-(float)i/(sectionsNum + 1))*0.5);//画笔线的颜色(透明度渐变)
    ...
    if (self.textLabel) {
        self.textLabel.frame = CGRectMake(0, self.center.y + 85, rect.size.width, 30);//([UIScreen mainScreen].bounds.size.height)/3.3
