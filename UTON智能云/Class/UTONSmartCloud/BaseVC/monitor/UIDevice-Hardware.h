...
#define IPHONE_X_NAMESTRING ([UIScreen instancesRespondToSelector:@selector(currentMode)] ? CGSizeEqualToSize(CGSizeMake(1125, 2436), [[UIScreen mainScreen] currentMode].size) : NO)
#define CCBSafeKeyboardHeight WS(IPHONE_X_NAMESTRING ? 292 : 258)
