...
#import "YanJiMomentViewController.h"
...
- (instancetype)initWithContext:(NSString *)context {
     ...
     * 更推荐后一种做法。
     */
    UIEdgeInsets imageInsets = UIEdgeInsetsMake(4.5, 0, -4.5, 0);//UIEdgeInsetsZero;//
...
- (NSArray *)viewControllersForTabBar {
    YanJiHomePageViewController *firstViewController = [[YanJiHomePageViewController alloc] init];
    UIViewController *firstNavigationController = [[CYLBaseNavigationController alloc]
                                                   initWithRootViewController:firstViewController];
    [firstViewController cyl_setHideNavigationBarSeparator:YES];
    // [firstViewController cyl_setNavigationBarHidden:YES];
    YanJiMomentViewController *secondViewController = [[YanJiMomentViewController alloc] init];
    ...
    YanJiPreparationViewController *thirdViewController = [[YanJiPreparationViewController alloc] init];
    ...
    YanJiMineViewController *fourthViewController = [[YanJiMineViewController alloc] init];
...
- (NSArray *)tabBarItemsAttributesForTabBar {
    ...
    NSDictionary *firstTabBarItemsAttributes = @{
                                                 CYLTabBarItemImage : [UIImage imageNamed:@"homeTarBar"],  /* NSString and UIImage are supported*/
                                                 CYLTabBarItemSelectedImage : @"homeTarBarSel",  /* NSString and UIImage are supported*/
...
//                                                 CYLTabBarLottieSize: [NSValue valueWithCGSize:CGSizeMake(22, 22)]
    ...
    NSDictionary *secondTabBarItemsAttributes = @{
                                                  CYLTabBarItemImage : [UIImage imageNamed:@"momentTabBar"],
                                                  CYLTabBarItemSelectedImage : @"momentTabBarSel",
...
//                                                  CYLTabBarLottieSize: [NSValue valueWithCGSize:CGSizeMake(33, 33)]
    ...
    NSDictionary *thirdTabBarItemsAttributes = @{
                                                 CYLTabBarItemImage : [UIImage imageNamed:@"preparationTabBar"],
                                                 CYLTabBarItemSelectedImage : @"preparationTabBarSel",
                                                 CYLTabBarItemTitlePositionAdjustment: [NSValue valueWithUIOffset:UIOffsetMake(-secondXOffset, -3.5)],
...
//                                                 CYLTabBarLottieSize: [NSValue valueWithCGSize:CGSizeMake(44, 44)]
    ...
    NSDictionary *fourthTabBarItemsAttributes = @{
                                                  CYLTabBarItemImage :[UIImage imageNamed:@"mineTabBar"],
                                                  CYLTabBarItemSelectedImage : @"mineTabBarSel",
                                                  CYLTabBarItemTitlePositionAdjustment: [NSValue valueWithUIOffset:UIOffsetMake(-firstXOffset, -3.5)],
...
- (void)customizeTabBarAppearanceWithTitlePositionAdjustment:(UIOffset)titlePositionAdjustment {
    ...
    selectedAttrs[NSForegroundColorAttributeName] = UIColorFromRGB(0xFF6D00);
...
//        standardAppearance.shadowColor = UIColorFromRGB(0x6354F2);//[UIColor cyl_systemGreenColor];
...
- (UIButton *)selectedCover {
    ...
    UIImage *image = [UIImage imageNamed:@"UTON_upload"];
